...
public class UpdateBiodata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.rawQuery("SELECT * FROM jadwal WHERE nama_matkul = '" +
        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                db.execSQL("update jadwal set nama_matkul='"+
                        text2.getText().toString() +"', hari='" +
                        text3.getText().toString()+"', waktu='"+
                        text4.getText().toString()+"', ruangan='"+
                        text5.getText().toString() +"', dosen='" +
                        text6.getText().toString() + "' where kode_matkul='" +
